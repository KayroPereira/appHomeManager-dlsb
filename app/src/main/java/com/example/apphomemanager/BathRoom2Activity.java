...
public class BathRoom2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_room2);

        //zona de adaptação para outros ambientes
        vgPrincipal = (ViewGroup) findViewById(R.id.ctnlPrincipalBTR2);

        pgBar = (ProgressBar) findViewById(R.id.pgBarCommBTR2);

        ivLightOnOff = (ImageView) findViewById(R.id.ivOnOffBTR2);

        ivBack = (ImageView) findViewById(R.id.ivBackBTR2);

        ivLight1 = (ImageView) findViewById(R.id.ivLight1BTR2);
        ivLight2 = (ImageView) findViewById(R.id.ivLight2BTR2);

        ivPower1 = (ImageView) findViewById(R.id.ivPower1BTR2);
        ...
        TYPE_DEVICE = constants.getBATHDROOM2();
