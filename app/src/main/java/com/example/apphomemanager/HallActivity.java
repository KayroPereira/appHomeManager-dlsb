...
public class HallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vgPrincipal = (ViewGroup) findViewById(R.id.ctnlPrincipalHALL);

        pgBar = (ProgressBar) findViewById(R.id.pgBarCommHALL);

        ivLightOnOff = (ImageView) findViewById(R.id.ivOnOffHALL);

        ivBack = (ImageView) findViewById(R.id.ivBackHALL);

        ivLight1 = (ImageView) findViewById(R.id.ivLight1HALL);
        ivLight2 = (ImageView) findViewById(R.id.ivLight2HALL);

        ivPower1 = (ImageView) findViewById(R.id.ivPower1HALL);
        ivPower2 = (ImageView) findViewById(R.id.ivPower2HALL);
        ivPower3 = (ImageView) findViewById(R.id.ivPower3HALL);
        ivPower4 = (ImageView) findViewById(R.id.ivPower4HALL);
        ivPower5 = (ImageView) findViewById(R.id.ivPower5HALL);
        ivPower6 = (ImageView) findViewById(R.id.ivPower6HALL);
